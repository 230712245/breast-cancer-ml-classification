# ==============================================================
# рџ©є Aplikasi Streamlit: Prediksi Kanker Payudara (21 Fitur Terbaik)
# ==============================================================
...
st.title("рџ©є Prediksi Diagnosis Kanker Payudara")
st.markdown("""
...
# -------------------------------------------------------------
# рџ§¬ 21 Fitur Terbaik yang Digunakan
# -------------------------------------------------------------
features = [
...
# рџ”® Prediksi
# -------------------------------------------------------------
if st.button("рџ”Ќ Prediksi Diagnosis"):
    ...
    # рџ”ё Tampilkan hasil utama
    if prediction == 1:
        st.error(f"рџ’Ђ **Hasil Prediksi: Ganas (1)**")
    else:
        st.success(f"рџЊї **Hasil Prediksi: Jinak (0)**")
 
    # рџ”ё Tampilkan probabilitas dengan bar chart
    st.markdown("### рџ“Љ Probabilitas Prediksi")
...
# рџ§© Info Tambahan
# -------------------------------------------------------------
with st.expander("в„№пёЏ Tentang Model"):
 st.markdown("""
    ...
    - **Label:**  
        ...
        - `1` в†’ Ganas (*Malignant*)  
    """)
 st.caption("Natanael Denis Putra Christmas")